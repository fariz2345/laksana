                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <table class="table table-striped" id="table1">
                                ...
                                <tbody>
								<?php
										$ambilsemuadatabarang = mysqli_query($conn, "select * from kelompok k, bayar y
                                         where k.idkel = y.idkel and k.cancel='0' order by k.idkel desc");
										$i = 1; 
								...
								?>
                                    <tr>
										...
										<td><?=$periode;?></td>
										<td><?=$ket;?></td>
										<td><a href="index.php?call=dist/detailbayar.php&idkel=<?=$idkel?>">
