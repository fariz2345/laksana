...
if (isset($_POST['beres'])) {
    ...
    $update = mysqli_query($conn, "update pemenangkel set sjh='1' where idpem='$idpem'");
}
                    ...
                    <table class="table table-striped" id="table1">
                        ...
                        <tbody>
                            ...
                            $ambilsemuadatabarang = mysqli_query($conn, "select * from pemenangkel p, kelompok k, barang b 
										where  k.idkel = p.idkel and b.kode = p.kode and p.sjh='0' and p.cancelp = '0' ");
                            $i = 1;
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td><?= $kota; ?></td>
                                    <td>
                                        <button type="button" class="btn btn-primary btn-sm " data-bs-toggle="modal" data-bs-target="#editform<?= $idpem; ?>">Beres SJH</button>
                                    </td>
                                            ...
                                            <form method="POST">
                                                ...
                                                <div class="modal-footer">
                                                    ...
                                                    <button type="submit" class="btn btn-primary ml-1" name="beres">
                                                        ...
                                                        <span class="d-none d-sm-block">Beres SJH</span>
                                                    </button>
                                                </div>
                                            </form>
                                        </div>
